...
function actionFormatter(value, row, index) {
    ...
    return [
        '<a href="' + routePrefix + '/clients/edit/' + row.id + '" title=' + label_update + '>' +
        ...
        '</button>' +
        '<a href="' + routePrefix + '/clients/' + row.id + '/permissions" title="Manage Permissions">' +
        '<i class="bx bxs-key mx-1  text-info"></i>' +
        '</a>'
    ]
}
