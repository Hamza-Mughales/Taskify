...
'total_tasks' => 'اجمالي المهام',
'total_users' => 'Total users',
'total_clients' => 'اجمالي العملاء',
'projects' => 'Projects',
'tasks' => 'المهام',
...
'subscription_support_closing' => 'We',
'payment_successfull' => 'Payment Successfull !!!',
'subscription_support' => 'IF YOU HAVENT RECEIVED YOUR SUBSCRIPTION AFTER 30 MINUTES, PLEASE DON "\"T HESITATE TO CONTACT OUR FRIENDLY SUPPORT TEAM AT',
'subscription_added' => 'YOUR SUBSCRIPTION REQUEST HAS BEEN RECEIVED SUCCESSFULLY. WE"\"RE WORKING ON ACTIVATING YOUR ACCOUNT RIGHT NOW, AND THIS PROCESS TYPICALLY TAKES UP TO 30 MINUTES TO COMPLETE.',
...
'estimate_id_prefix' => 'Estimate ID prefix',
'invoice_id_prefix' => 'Invoice ID prefix',
...
'streamlineProjectDesc' => 'Take control of your projects and boost team productivity with Taskify-SaaS ,the all-in-one project management and task management solution. Our cloud-based platform empowers you to effortlessly organize projects, collaborate with your team, and track progress – all in one place.',
...
'seamlessCollaborationDesc' => 'Foster a collaborative work environment with Taskify-SaaS. Assign tasks,share files, and communicate effectively with your team in real-time. Ensure everyone is on the same page and working towards a common goal.',
...
'effectiveTaskDesc' => 'Organize chaos: Break down complex projects into manageable tasks and subtasks using our flexible workspace system. Keep track of progress with customizable task statuses (e.g., "ToDo," "In Progress," "Completed") and prioritize effectively by highlighting critical tasks.',
...
'aboutUsCTA' => 'Ready to experience the Taskify SaaS difference? Sign up and see how we can help your team achieve more!',
'taskify_features_heading' => 'Taskify SaaS Powerful Features for Efficient Project Management',
...
'login_as_superadmin' => 'Login as the SuperAdmin',
'login_as_admin' => 'Login as the Admin',
'login_as_team_member' => 'Login as the Team Member',
'login_as_client' => 'Login as the Client',
...
'centralized_project_data' => 'Centralized project data',
