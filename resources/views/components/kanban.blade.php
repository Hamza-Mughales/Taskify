...
<div class="card m-2 shadow" data-task-id="{{ $task->id }}">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h6 class="card-title"><a data-bs-toogle="tooltip" data-bs-placement='bottom' title="{{ $task->description }}" href="{{ route('tasks.info', ['id' => $task->id]) }}"
                ...
                <div class="input-group">
                    ...
                    <ul class="dropdown-menu">
                        <li class="dropdown-item">
                            <a href="{{ Request::segment(1) == 'projects' ? route('projects.tasks.edit', ['id' => $task->id]) : route('tasks.edit', ['id' => $task->id]) }}"
                                class="card-link">
        ...
        <div class="card-subtitle text-muted mb-3" data-bs-toogle="tooltip" data-bs-placement='bottom' title="{{ $task->project->description }}">{{ $task->project->title }}</div>
        <div class="row mt-2">
            <div class="col-md-6">
                <p class="card-text">
