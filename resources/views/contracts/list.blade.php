        ...
        <div class="card ">
                        ...
                        <div class="col-md-3 mb-4">
                            <select class="form-select" id="status_filter" aria-label="Default select example">
                                ...
                                <option value="partially_signed">
                                    <?= get_label('partially_signed', 'Partially signed') ?>
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="table-responsive text-nowrap">
                ...
                <table id="contracts_table" data-toggle="table" data-loading-template="loadingTemplate"
                    data-url="{{ route('contracts.list') }}" data-icons-prefix="bx" data-icons="icons"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-formatter="idFormatter"><?= get_label('id', 'ID') ?>
                            </th>
                            <th data-sortable="true" data-field="title"><?= get_label('title', 'Title') ?>
                            </th>
                            <th data-sortable="false" data-field="client"><?= get_label('client', 'Client') ?>
                            </th>
                            <th data-sortable="false" data-field="project">
                                <?= get_label('project', 'Project') ?>
                            </th>
                            <th data-sortable="false" data-field="contract_type">
                                <?= get_label('type', 'Type') ?>
                            </th>
                            <th data-sortable="true" data-field="start_date">
                                <?= get_label('starts_at', 'Starts at') ?></th>
                            <th data-sortable="true" data-field="end_date">
                                <?= get_label('ends_at', 'Ends at') ?>
                            </th>
                            <th data-sortable="false" data-field="duration" data-visible="false">
                                <?= get_label('duration', 'Duration') ?></th>
                            <th data-sortable="true" data-field="value"><?= get_label('value', 'Value') ?>
                                ({{ $general_settings['currency_symbol'] }})</th>
                            <th data-sortable="true" data-field="promisor_sign" data-visible="false">
                                <?= get_label('promisor_sign_status', 'Promisor sign status') ?></th>
                            <th data-sortable="true" data-field="promisee_sign" data-visible="false">
