...
@section('content')
    ...
    <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="card-title mb-2">
                                {{ is_countable($projects) && count($projects) > 0 ? count($projects) : 0 }}</h3>
                            <a href="{{ route('projects.index') }}"><small class="text-success fw-semibold"><i
                ...
                <div class="col-lg-3 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('tasks.index') }}"><small class="text-primary fw-semibold"><i
                                        class="bx bx-right-arrow-alt"></i><?= get_label('view_more', 'View more') ?></small></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">{{ is_countable($users) && count($users) > 0 ? count($users) : 0 }}
                                </h3>
                                <a href="{{ route('users.index') }}"><small class="text-warning fw-semibold"><i
                                            class="bx bx-right-arrow-alt"></i><?= get_label('view_more', 'View more') ?></small></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">
                                    {{ is_countable($clients) && count($clients) > 0 ? count($clients) : 0 }}</h3>
                                <a href="{{ route('clients.index') }}"><small class="text-info fw-semibold"><i
                                            class="bx bx-right-arrow-alt"></i><?= get_label('view_more', 'View more') ?></small></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">
                                    {{ is_countable($meetings) && count($meetings) > 0 ? count($meetings) : 0 }}</h3>
                                <a href="{{ route('users.index') }}"><small class="text-warning fw-semibold"><i
                                            class="bx bx-right-arrow-alt"></i><?= get_label('view_more', 'View more') ?></small></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title mb-2">
                                    {{ is_countable($total_todos) && count($total_todos) > 0 ? count($total_todos) : 0 }}</h3>
                                <a href="{{ route('todos.index') }}"><small class="text-info fw-semibold"><i
                                            class="bx bx-right-arrow-alt"></i><?= get_label('view_more', 'View more') ?></small></a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <li class="d-flex mb-4 pb-1">
                                        ...
                                        <div
                                            ...
                                            <div class="me-2">
                                                ...
                                                <a href="{{ route('projects.index', ['status' => $status->id]) }}">
                                                    <h6 class="mb-0">{{ $status->title }}</h6>
                                                </a>
                                            </div>
                                            <div class="user-progress">
                                                <small
                                                    class="fw-semibold"><?= $count = isAdminOrHasAllDataAccess() ? count($status->projects) : $auth_user->status_projects($status->id)->count() ?></small>
                                            </div>
                                ...
                                @foreach ($statuses as $status)
                                    <li class="d-flex mb-4 pb-1">
                                        ...
                                        <div
                                            class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            <div class="me-2">
                                                <a href="{{ route('tasks.index', ['status' => $status->id]) }}">
                                                    <h6 class="mb-0">{{ $status->title }}</h6>
                                                </a>
                                            </div>
                                            <div class="user-progress">
                                                <small
                                                    class="fw-semibold"><?= $count = isAdminOrHasAllDataAccess() ? count($status->tasks) : $auth_user->status_tasks($status->id)->count() ?></small>
                                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex justify-content-between pt-3 pb-0">
                            ...
                            <div>
                                ...
                                <a href="{{ route('todos.index') }}"><button type="button"
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            <div class="avatar flex-shrink-0">
                                                <input type="checkbox" id="{{ $todo->id }}"
                                                    data-url = "{{ route('todos.update_status') }}"
                                            ...
                                            <div
                                                class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                                    <h6 class="mb-0 <?= $todo->is_completed ? 'striked' : '' ?>"
                                                        id="{{ $todo->id }}_title">{{ $todo->title }}</h6>
                                                    <small
                                                        class="text-muted d-block mb-1">{{ format_date($todo->created_at, 'H:i:s') }}</small>
                                                </div>
                                                <div class="user-progress d-flex align-items-center gap-1">
                                                    <a href="javascript:void(0);" class="edit-todo"
                                                        data-url="{{ route('todos.get', ['id' => $todo->id]) }}"
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                        ...
                        aria-selected="true">
                        <i
                            class="menu-icon tf-icons bx bx-cake text-success"></i><?= get_label('upcoming_birthdays', 'Upcoming birthdays') ?>
                    </button>
                </li>
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        ...
                        <i
                            class="menu-icon tf-icons bx bx-star text-primary"></i><?= get_label('upcoming_work_anniversaries', 'Upcoming work anniversaries') ?>
                    </button>
                </li>
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        ...
                        aria-selected="false">
                        <i
                            class="menu-icon tf-icons bx bx-home text-danger"></i><?= get_label('members_on_leave', 'Members on leave') ?>
                    </button>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane fade active show" id="navs-top-upcoming-birthdays" role="tabpanel">
                    @if (!$auth_user->dob)
                        <div class="alert alert-primary alert-dismissible" role="alert">
                            <?= get_label('dob_not_set_alert', 'Your DOB is not set') ?>, <a
                                href="{{ route('users.edit', [$auth_user->id]) }}"
                ...
                <div class="tab-pane fade" id="navs-top-upcoming-work-anniversaries" role="tabpanel">
                    ...
                    <div class="">
                        <div class="d-flex justify-content-between">
                            <h4 class="fw-bold">
                                <?= get_label('upcoming_work_anniversaries', 'Upcoming work anniversaries') ?></h4>
                        </div>
        ...
        $pending_todos = 0;
        $todo_counts = [];
        $ran = ['#63ed7a', '#ffa426', '#fc544b', '#6777ef', '#FF00FF', '#53ff1a', '#ff3300', '#0000ff', '#00ffff', '#99ff33', '#003366', '#cc3300', '#ffcc00', '#ff00ff', '#ff9900', '#3333cc', '#ffff00'];
