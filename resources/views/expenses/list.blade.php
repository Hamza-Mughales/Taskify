                ...
                @if ($expenses > 0)
                    ...
                    <div class="table-responsive text-nowrap">
                        <table id="table" data-toggle="table" data-loading-template="loadingTemplate"
                            data-url="{{ route('expenses.list') }}" data-icons-prefix="bx" data-icons="icons"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true" data-field="expense_type_id" data-visible="false">
                                        <?= get_label('expense_type_id', 'Expense type ID') ?></th>
                                    <th data-sortable="true" data-field="expense_type">
                                        <?= get_label('expense_type', 'Expense type') ?></th>
                                    <th data-sortable="true" data-field="user_id" data-visible="false">
                                    ...
                                    <th data-sortable="true" data-field="expense_date">
                                        <?= get_label('expense_date', 'Expense date') ?></th>
                                    <th data-sortable="true" data-field="note" data-visible="false">
                                        <?= get_label('note', 'Note') ?></th>
                                    <th data-sortable="false" data-field="created_by" data-visible="false">
                                    ...
                                    <th data-formatter="expensesActionsFormatter">
