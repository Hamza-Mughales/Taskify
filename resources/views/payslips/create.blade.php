                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                            <label class="form-label" for=""><?= get_label('working_days', 'Working days') ?> <span
                                    class="asterisk">*</span></label>
                            <input class="form-control" type="number" min="0"  max="31" id="working_days" name="working_days" step="0.01"
                        ...
                        <div class="mb-3 col-md-4">
                            <label class="form-label" for=""><?= get_label('lop_days', 'Loss of pay days') ?> <span
                                    class="asterisk">*</span></label>
                            <input class="form-control" type="number"  min="0"  max="31" id="lop_days" name="lop_days" step="0.01"
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text">{{ $general_settings['currency_symbol'] }}</span>
                                <input class="form-control min_0" min="0" type="number" id="bonus" name="bonus" step="0.01"
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text">{{ $general_settings['currency_symbol'] }}</span>
                                <input class="form-control min_0" min="0" type="number" id="incentives" name="incentives"
