            ...
            <div class="card-body">
                <form method="POST" action="{{ route('plans.update', $plan->id) }}" id="plan-update-form"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="planName" class="form-label bold"><?= get_label('name', 'Name:') ?></label>
                            ...
                            <div class="col-md-6">
                                <label for="planDescription"
                                    class="form-label bold"><?= get_label('description', 'Description:') ?></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="maxProjects"
                                    class="form-label bold"><?= get_label('max_projects', 'Maximum Projects:') ?></label>
                            ...
                            <div class="col-md-3">
                                <label for="maxClients"
                                    class="form-label bold"><?= get_label('max_clients', 'Maximum Clients:') ?></label>
                            ...
                            <div class="col-md-3">
                                <label for="maxTeamMembers"
                                    class="form-label bold"><?= get_label('max_team_members', 'Maximum Team Members:') ?></label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 monthly_tenure">
                                <div class="card">
                                    <div class="card-body ">
                                        <h5 class="card-title">{{ get_label('monthly', 'Monthly') }}</h5>
                                        <div class="mb-3">
                            ...
                            <div class="col-md-4 yearly_tenure">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ get_label('yearly', 'Yearly') }}</h5>
                                        <div class="mb-3">
                                            <label for="yearlyPrice"
                                                class="form-label"><?= get_label('price', 'Price:') ?></label>
                                            <input type="number" class="form-control tenure-price" id="yearly_price"
                                                min="0" value="{{ $plan->yearly_price }}" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control tenure-discounted-price"
                                                ...
                                                value="{{ $plan->yearly_discounted_price }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 lifetime_tenure">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ get_label('lifetime', 'Lifetime') }}</h5>
                                        <div class="mb-3">
                                            <label for="lifetimePrice"
                                                class="form-label"><?= get_label('price', 'Price:') ?></label>
                                            <input type="number" class="form-control tenure-price" id="lifetime_price"
                                                min="0" value="{{ $plan->lifetime_price }}" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control tenure-discounted-price"
                                                ...
                                                value="{{ $plan->lifetime_discounted_price }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <h3><?= get_label('module_selection', 'Module Selection:') ?></h3>
                            </div>
                            <div class="col-md-12">
                                <!-- Select All Checkbox -->
