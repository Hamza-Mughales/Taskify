...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mt-4">
            ...
            <div>
                <a href="{{ route('users.create') }}"><button type="button" class="btn btn-sm btn-primary"
                        data-bs-toggle="tooltip" data-bs-placement="left"
                        data-bs-original-title="<?= get_label('create_user', 'Create user') ?>"><i
                ...
                <div class="card-body">
                    <div class="table-responsive text-nowrap">
                        ...
                        <table id="table" data-toggle="table" data-loading-template="loadingTemplate"
                            data-url="{{ route('users.list') }}" data-icons-prefix="bx" data-icons="icons"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-formatter="userFormatter" data-sortable="true" data-field="first_name">
